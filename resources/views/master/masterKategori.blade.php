...
<div class="card mt-3 mb-3 mr-2 ml-2 rounded-b-2xl">
    ...
    justify-content: flex-end;" id="addBtn" data-toggle="modal" data-target="#modalKategori">
               <span id="addIcon" 
...
<div id="modalForm" modal-center
    ...
    <div class="w-screen lg:w-[55rem] bg-white shadow rounded-md dark:bg-zink-600 flex flex-col h-full">
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
             <form id = "KategoriForm" method="POST" action="{{ url('process/addKategori') }}" enctype="multipart/form-data" >
            <div class="grid grid-cols-1 gap-5 md:grid-cols-1 xl:grid-cols-1 mx-5 ">
                <div class="mb-3">
                    <label for="inputText" class="inline-block mb-2 text-base font-medium">Nama Kategori <span
