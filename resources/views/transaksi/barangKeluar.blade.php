...
<div class="mt-3 mb-3 mr-2 ml-2">
    <h3 class="text-slate-600">Barang Keluar</h3>
</div>

<div class="card mt-3 mb-3 mr-2 ml-2 rounded-b-2xl">
    <div class="card-header bg-slate-200 ">
        <button type="button"
            class="btn bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4  inline-flex items-center mb-2 mt-2"
            style="
    justify-content: flex-end;" id="addBtn" data-toggle="modal" data-target="#modalBarang">
            <span id="addIcon" class="min-w-[0.50rem] inline-block text-start text-[16px]">
        ...
        <table class="display w-full text-center table-auto min-w-max" style="width:100%" id="myTable">
            <thead>
                <tr>
                    ...
                    <th class="text-center cursor-pointer hover:bg-gray-100">Tanggal</th>
                    <th class="text-center cursor-pointer hover:bg-gray-100">Nama Barang</th>
                    <th class="text-center cursor-pointer hover:bg-gray-100">Merek</th>
                    <th class="text-center cursor-pointer hover:bg-gray-100">
                        Kategori
                    </th>
                    <th class="text-center cursor-pointer hover:bg-gray-100">Keterangan</th>
                    <th class="text-center cursor-pointer hover:bg-gray-100">Jumlah</th>
