...
<body class="font-public">
    ...
    <div
        ...
        <!-- Left: Login Card -->
        <div
            class="loginCard min-h-[calc(100vh_-_theme('spacing.4')_*_2)] mx-3 md:w-[28rem] lg:w-[40rem] shrink-0 px-6 md:px-8 lg:px-10 py-10 md:py-14 flex items-center justify-center m-4 bg-white rounded z-10 relative dark:bg-zink-700 dark:text-zink-100 mx-3 md:mx-auto xl:mx-4 ml-3 md:ml-0">
        ...
        <div
            ...
            <div>
                ...
                <div class="mt-2 text-center">
                    ...
                    <p id="infoSub" class="max-w-2xl mx-auto text-custom-300 text-base">Created with &#128151; by MIS
                        PT.Globalindo Intimates</p>
                </div>
    ...
    signInBtn.addEventListener('click', function() {
        ...
        fetch(url, {
            ...
            .then(data => {
                if (data.message == "Incorrect password." || data.message ==
                    "These credentials do not match our records (username not found).") {
                    Swal.fire({
                        title: 'Oops!',
                    ...
                    return;
                } else if (data.message == "Credentials verified successfully.") {
