    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div class="flex flex-col">
                    <label for="select2" class="mb-1 text-sm font-medium text-gray-700 dark:text-zink-200">Select 2</label>
                    <select class="select2 border border-gray-300 dark:border-zink-500 rounded px-3 py-2 w-full bg-white dark:bg-zink-600 text-sm">
                        <option selected>Select</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
